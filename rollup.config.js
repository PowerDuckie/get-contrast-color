...
export default [
    ...
    {
        input: "./index.js",  // Entry point of the library
        output: {
            name: "getContrastColor",   // Global variable name (fallback for UMD)
    ...
    // 3. UMD output (Universal Module Definition - works in browsers and Node.js)
    {
        input: "./index.js",
        output: {
            name: "getContrastColor",   // Global variable exposed in browser environments
